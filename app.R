...
ui <- shinyMobile::f7Page(
  ...
  #    refreshColour = "grey"
  #  ), 
  title = paste0("  ArxEd | Analytics Salary Projections"),  
  options = list(dark = F),
  tags$script(src = "myscript.js"),
  shinyMobile::f7SingleLayout(
    tags$head(
      tags$link(rel="shortcut icon", href="https://raw.githubusercontent.com/SCasanova/arxed_ddd/main/Logos/ArxEd%20logo%20fnl_Combo%20ArxEd.png"),
    ...
    navbar = shinyMobile::f7Navbar(
      title = tags$div(
        tags$img(src='https://raw.githubusercontent.com/SCasanova/arxed_ddd/main/Logos/ArxEd%20logo%20fnl_Combo%20ArxEd.png',
                 width='45px'),
        width='45px'),
      tags$span(h3(paste0("  ArxEd | Analytics Salary Projections")), 
  ...
  output$budget_plot <- plotly::renderPlotly({
    plotly::plot_ly(
      ...
      plotly::layout(
        ...
        font = list(size = 18),
        images = list(
          source = "https://raw.githubusercontent.com/SCasanova/arxed_ddd/main/www/ArxEd%20logo%20fnl_Combo%20Stacked%20Analytics.png",
          x = -0.03, y = -0.1,
  ...
  summary_tab <- reactive({
    table_data() %>%
      ...
      gt::fmt_number(columns = c(perc_increase),
                     ...
                     patter = '{x}%') %>%
      gt::tab_source_note(
        source_note = gt::html(paste0(tags$span(style = "font-size:17px;" , tags$span(tags$img(src='https://raw.githubusercontent.com/SCasanova/arxed_ddd/main/www/ArxEd%20logo%20fnl_Secondary%20org%20blue.png',width='22px', style = 'margin-right:3px;margin-bottom:-3px;')), "ArxEd | Analytics", ' Forecasting')))
      ) %>%
      # gt::tab_source_note(
